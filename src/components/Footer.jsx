    ...
    <footer style={{ borderTop: '1px solid #D9D9D9' }}>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4'>
        ...
        <div className='pt-9 pe-10'>
          ...
          <input type="text" placeholder='Enter Your Email Address' style={{ borderBottom: '1px solid black9', padding: '5px' }} />
          <span style={{ fontWeight: '500',  borderBottom: '1px solid black', fontWeight: '500', padding: '4px' }}>SUBSCRIBE</span>
        </div>
      </div>
